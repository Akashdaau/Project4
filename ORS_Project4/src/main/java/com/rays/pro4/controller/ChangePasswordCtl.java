...
public class ChangePasswordCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		 ...
		 * ServletUtility.
		 * setErrorMessage("New and confirm passwords should be matched", request);
		 * 
		 * pass = false; }
		 */
		 ...
		 * "newPassword"))) { ServletUtility.
		 * setErrorMessage("Old and NewPasswords should not be same", request);
		 * 
		 * pass = false; }
		 */
